...
/**
 * Pixel toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = PixelIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
/**
 * Pixel icon button default values.
 */
object PixelIconButtonDefaults {
    // TODO: File bug
