...
/**
 * Pixel view toggle button with included trailing icon as well as compact and expanded
...
fun PixelViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = PixelViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        PixelViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) PixelIcons.ViewDay else PixelIcons.ShortText,
...
/**
 * Internal Pixel view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun PixelViewToggleButtonContent(
...
/**
 * Pixel view toggle default values.
 */
object PixelViewToggleDefaults {
    // TODO: File bug
